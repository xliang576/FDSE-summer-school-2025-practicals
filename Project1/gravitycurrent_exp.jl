...
function gravitycurrent_exp(Δb)
  ...
  run!(simulation)
  plot_gravitycurrent(filename)
end

Δb_list = [1,2,4,6] # Set the change in the non-dimensional buouancy 
for Δb in Δb_list
  gravitycurrent_exp(Δb)
end